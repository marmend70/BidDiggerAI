    ...
    return (
        <>
            <footer className="bg-slate-950 border-t border-slate-800 py-6 mt-auto">
                <div className="max-w-7xl mx-auto px-4 md:px-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-400">
                    <div className="flex items-center gap-2">
                        <Mail className="h-4 w-4" />
                        <span>Contatti:</span>
                        <a href="mailto:mm.infoapps@gmail.com" className="text-slate-300 hover:text-blue-400 font-medium transition-colors">
